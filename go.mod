...
require (
	github.com/IBM/sarama v1.45.1 // for kafka
	...
	github.com/nats-io/nats.go v1.41.1 // for nats, natstream
	github.com/nats-io/stan.go v0.10.4 // for nats, natstream
	github.com/pkg/errors v0.9.1
	github.com/redis/go-redis/v9 v9.7.3 // for redis, wrappers/once/redis
